...
const CallToAction = () => {
    ...
    return (
        <motion.div
            ref={ref}
            className="bg-[#14141F] py-20 text-center px-4 flex flex-col md:flex-row items-center justify-between"
        ...
        >
            ...
            <div className="flex flex-col items-center w-full md:w-1/3">
                <h2 className="text-2xl md:text-3xl font-bold mb-4 text-amber-800">
                    Transform Your Ideas into Reality
                </h2>
                <p className="text-sm md:text-base mb-6 max-w-6xl mx-auto text-gray-200" style={{lineHeight: "1.8"}}>
                ...
                <Link href="/#contact-me"> {/* Use the hash to link to the ID */}
                    <motion.button
                        className="border-l-8 border-purple-500 bg-gradient-to-r from-blue-800 to-orange-600 text-white px-8 py-4 rounded-lg hover:bg-blue-500 transition-all duration-300 transform hover:scale-105"
